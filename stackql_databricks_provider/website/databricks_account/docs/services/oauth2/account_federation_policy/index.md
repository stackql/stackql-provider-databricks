---
title: account_federation_policy
hide_title: false
...
Creates, updates, deletes, gets or lists an <code>account_federation_policy</code> resource.
...
<Tabs
    defaultValue="account_federation_policy_get"
    values={[
        { label: 'account_federation_policy_get', value: 'account_federation_policy_get' },
        { label: 'account_federation_policy_list', value: 'account_federation_policy_list' }
    ]}
>
<TabItem value="account_federation_policy_get">
...
<TabItem value="account_federation_policy_list">
...
<tbody>
<tr>
    <td><a href="#account_federation_policy_get"><CopyableCode code="account_federation_policy_get" /></a></td>
...
<tr>
    <td><a href="#account_federation_policy_list"><CopyableCode code="account_federation_policy_list" /></a></td>
    <td><CopyableCode code="select" /></td>
...
<tr>
    <td><a href="#account_federation_policy_delete"><CopyableCode code="account_federation_policy_delete" /></a></td>
...
<Tabs
    defaultValue="account_federation_policy_create"
    values={[
        { label: 'account_federation_policy_create', value: 'account_federation_policy_create' },
        { label: 'Manifest', value: 'manifest' }
    ]}
>
<TabItem value="account_federation_policy_create">
...
<Tabs
    defaultValue="account_federation_policy_update"
    values={[
        { label: 'account_federation_policy_update', value: 'account_federation_policy_update' }
    ]}
>
<TabItem value="account_federation_policy_update">
...
<Tabs
    defaultValue="account_federation_policy_delete"
    values={[
        { label: 'account_federation_policy_delete', value: 'account_federation_policy_delete' }
    ]}
>
<TabItem value="account_federation_policy_delete">
