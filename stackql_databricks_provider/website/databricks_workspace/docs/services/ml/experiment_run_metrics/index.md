...
Creates, updates, deletes, gets or lists an <code>experiment_run_metrics</code> resource.
...
<tr id="parameter-page_token">
    ...
    <td><code>string</code></td>
    <td>Token indicating the page of metric histories to fetch.</td>
</tr>
<tr id="parameter-run_id">
    <td><CopyableCode code="run_id" /></td>
    <td><code>string</code></td>
    <td>ID of the run from which to fetch metric values. Must be provided.</td>
</tr>
