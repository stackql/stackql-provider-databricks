...
Creates, updates, deletes, gets or lists an <code>automatic_cluster_update</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="automatic_cluster_update" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="databricks_workspace.settings.automatic_cluster_update" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Gets the automatic cluster update setting.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Updates the automatic cluster update setting for the workspace. A fresh etag needs to be provided in</td>
</tr>
</tbody>
</table>
...
etag
FROM databricks_workspace.settings.automatic_cluster_update
...
```sql
UPDATE databricks_workspace.settings.automatic_cluster_update
SET 
