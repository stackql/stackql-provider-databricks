...
<SchemaTable fields={[
  ...
  },
  {
    ...
    "children": [
      ...
      {
        "name": "disable_gov_tag_creation",
        "type": "boolean",
        "description": "When true, workspace admins cannot create governance tags. ALLOW_ALL status does not override this; they are independent."
      }
    ]
  },
  {
...
<tr>
    ...
    <td><a href="#parameter-name"><code>name</code></a>, <a href="#parameter-deployment_name"><code>deployment_name</code></a>, <a href="#parameter-setting"><code>setting</code></a></td>
    <td></td>
