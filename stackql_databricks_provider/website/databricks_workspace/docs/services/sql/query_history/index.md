...
<SchemaTable fields={[
  ...
  },
  {
    "name": "statement_type",
    "type": "string",
    "description": "Type of statement for this query (ALTER, ANALYZE, CALL, COPY, CREATE, DELETE, DESCRIBE, DROP, EXPLAIN, GRANT, INSERT, MERGE, OPTIMIZE, OTHER, REFRESH, REPLACE, REVOKE, SELECT, SET, SHOW, TRUNCATE, UPDATE, USE)"
  },
  {
    "name": "status",
    "type": "string",
    "description": "Statuses which are also used by OperationStatus in runtime. When adding a new QueryStatus, make<br />sure to update com.databricks.sqlgateway.history.QueryStatusOrdering (CANCELED, COMPILED, COMPILING, FAILED, FINISHED, QUEUED, RUNNING, STARTED)"
  }
]} />
</TabItem>
</Tabs>
