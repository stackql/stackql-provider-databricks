...
<SchemaTable fields={[
  ...
  },
  {
    "name": "enable_photon",
    "type": "boolean",
    "description": "Configures whether the warehouse should use Photon optimized clusters. Defaults to true."
  },
  {
  ...
  },
  {
    "name": "warehouse_type",
    "type": "string",
    "description": "Warehouse type: ``PRO`` or ``CLASSIC``. If you want to use serverless compute, you must set to ``PRO`` and also set the field ``enable_serverless_compute`` to ``true``. (CLASSIC, PRO, REALTIME, REYDEN, TYPE_UNSPECIFIED)"
  }
]} />
</TabItem>
<TabItem value="list">
...
<tr id="parameter-run_as_user_id">
    ...
    <td><code>integer</code></td>
    <td>Deprecated: this field is ignored by the server. Service Principal which will be used to fetch the list of endpoints. If not specified, SQL Gateway will use the user from the session header.</td>
</tr>
</tbody>
</table>
