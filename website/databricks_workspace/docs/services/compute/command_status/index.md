...
Creates, updates, deletes, gets or lists a <code>command_status</code> resource.
...
<Tabs
    defaultValue="contextstatus"
    values={[
        { label: 'contextstatus', value: 'contextstatus' }
    ]}
>
<TabItem value="contextstatus">
...
<tbody>
<tr>
    <td><a href="#contextstatus"><CopyableCode code="contextstatus" /></a></td>
