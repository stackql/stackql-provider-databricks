...
Creates, updates, deletes, gets or lists a <code>spark_versions</code> resource.
...
<Tabs
    defaultValue="sparkversions"
    values={[
        { label: 'sparkversions', value: 'sparkversions' }
    ]}
>
<TabItem value="sparkversions">
...
<tbody>
<tr>
    <td><a href="#sparkversions"><CopyableCode code="sparkversions" /></a></td>
