...
Creates, updates, deletes, gets or lists a <code>provider_analytics_dashboards</code> resource.
...
<tr>
    ...
    <td><a href="#parameter-deployment_name"><code>deployment_name</code></a></td>
    <td></td>
    <td>Create provider analytics dashboard. Returns Marketplace specific</td>
</tr>
<tr>
...
- name: provider_analytics_dashboards
  props:
    - name: deployment_name
      value: string
      description: Required parameter for the provider_analytics_dashboards resource.
```
</TabItem>
</Tabs>
