...
<Tabs
    defaultValue="buildlogs"
    values={[
        { label: 'buildlogs', value: 'buildlogs' }
    ]}
>
<TabItem value="buildlogs">

Build logs were fetched successfully.
...
<tbody>
<tr>
    <td><a href="#buildlogs"><CopyableCode code="buildlogs" /></a></td>
