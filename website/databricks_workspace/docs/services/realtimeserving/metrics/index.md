...
<tbody>
<tr>
    <td><a href="#exportmetrics"><CopyableCode code="exportmetrics" /></a></td>
    <td><CopyableCode code="exec" /></td>
    <td><a href="#parameter-deployment_name"><code>deployment_name</code></a></td>
    <td></td>
    <td>Retrieves the metrics associated with the provided serving endpoint in either Prometheus or OpenMetrics exposition format.</td>
</tr>
</tbody>
</table>
...
<Tabs
    defaultValue="exportmetrics"
    values={[
        { label: 'exportmetrics', value: 'exportmetrics' }
    ]}
>
<TabItem value="exportmetrics">
