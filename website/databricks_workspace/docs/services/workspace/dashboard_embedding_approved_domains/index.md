...
Creates, updates, deletes, gets or lists a <code>dashboard_embedding_approved_domains</code> resource.
...
<tr>
    <td><CopyableCode code="aibi_dashboard_embedding_approved_domains" /></td>
...
<tr>
    ...
    <td><a href="#parameter-deployment_name"><code>deployment_name</code></a></td>
    <td></td>
    <td>Updates the list of domains approved to host embedded AI/BI dashboards. This update will fail if the current workspace access policy is not ALLOW_APPROVED_DOMAINS.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-deployment_name"><code>deployment_name</code></a></td>
    <td></td>
    <td>Delete the list of domains approved to host embedded AI/BI dashboards, reverting back to the default empty list.</td>
</tr>
</tbody>
</table>
